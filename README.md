...
* **Phase3: SaaS Analytics Pipeline**
  ...
  The project builds a deterministic data pipeline from synthetic data generation to analytics-ready marts using a layered architecture (raw → staging → foundation → marts).
...
* **Phase2: E-Commerce Data Warehouse Pipeline**
  ...
  **Repo:** [Phase2 E-Commerce Project](https://github.com/faqihalamin95/ecommerce-data-pipeline)
